...
namespace DoctrineProxies\__CG__\GuestUser\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class GuestUserToken extends \GuestUser\Entity\GuestUserToken implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (GuestUserToken $proxy) {
