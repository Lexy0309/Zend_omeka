 ...
 */
class DownloadLog extends \DownloadManager\Entity\DownloadLog implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'status', 'resource_id', 'owner_id', 'expire', 'log', 'hash', 'hashPassword', 'salt', 'created', 'modified'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (DownloadLog $proxy) {
    ...
    public function setResourceIdentifier($resourceId)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setResourceIdentifier', [$resourceId]);

        return parent::setResourceIdentifier($resourceId);
    }
